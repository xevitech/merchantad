  ...
  <section class="sidebar">
    <ul class="sidebar-menu">
                ...
                @if (is_incevio_package_loaded('auction'))
                  <li class="{{ Request::is('admin/stock/inventory/auction') || (isset($inventory) && $inventory->auctionable) ? 'active' : '' }}">
                    <a href="{{ route('admin.stock.inventory.index', ['type' => 'auction']) }}">
                      <i class="fa fa-angle-double-right"></i> {{ trans('packages.auction.auction_items') }}
                    </a>
                  </li>
                @endif
              @endcan
      ...
      @if (Gate::allows('index', \App\Models\User::class) || Gate::allows('index', \App\Models\Customer::class) || Gate::allows('index', \Incevio\Package\Inspector\Models\InspectorModel::class))
        <li class="treeview {{ Request::is('admin/admin*') || Request::is('address/addresses/customer*') || Request::is('admin/inspector*') || Request::is('admin/affiliate') ? 'active' : '' }}">
          ...
          <ul class="treeview-menu">
            ...
            {{-- @can('index', \App\Models\Affiliate::class) --}}
      ...
      @if (is_incevio_package_loaded('buyerGroup') && Auth::user()->isAdmin())
        <li class="treeview {{ Request::is('admin/buyerGroup*') ? 'active' : '' }}">
          <a href="javascript:void(0)">
            <i class="fa fa-users"></i>
            <span>{{ trans('packages.buyer_group') }}</span>
            @include('partials._addon_badge')
            <i class="fa fa-angle-left pull-right"></i>
          </a>
          <ul class="treeview-menu">
            <li class="{{ Request::is('admin/buyerGroup*') && !Request::is('admin/buyerGroup/applications*') ? 'active' : '' }}">
              <a href="{{ url('admin/buyerGroup') }}">
                <i class="fa fa-angle-double-right"></i> <span>{{ trans('packages.buyer_groups') }}</span>
              </a>
            </li>

            <li class="{{ Request::is('admin/buyerGroup/applications*') ? 'active' : '' }}">
              <a href="{{ route('buyerGroup.applications') }}">
                <i class="fa fa-angle-double-right"></i> <span>{{ trans('packages.applications') }}</span>
              </a>
            </li>
          </ul>
        </li>
        ...
        <li class="treeview {{ Request::is('admin/utility*') ? 'active' : '' }}">
          ...
          <ul class="treeview-menu">
            ...
            @if (Auth::user()->isAdmin() && is_incevio_package_loaded('smartForm'))
              <li class="{{ Request::is('admin/utility/smartForm*') ? 'active' : '' }}">
                <a href="{{ route('admin.utility.smartForm.index') }}">
                  <i class="fa fa-angle-double-right"></i> {{ trans('packages.smartForm.smart_forms') }}
                  @include('partials._addon_badge')
                </a>
              </li>
            @endif
